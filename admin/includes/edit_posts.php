<?php
        ...
        if (isset($_POST['update_post'])){
            ...
            //move image from temp to permenant location
            move_uploaded_file($post_image_temp, "../images/$post_image");

            //image preview, make sure it isnt empty and if it is get it from database
            if (empty($post_image)){
            	$query = "SELECT * FROM posts WHERE post_id = $the_post_id ";
...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">	
        ...
        //dropdown says if post status is published show draft as an option
