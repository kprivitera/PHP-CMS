...
<?php 
    ...
    $unnaproved_comments_query = mysqli_query($connect, $query);
    $unnaproved_comments_count = mysqli_num_rows($unnaproved_comments_query);
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          $element_text = [ 'All Posts', 'Active Posts', 'Draft Posts', 'Comments', 'Pending Comments', 'Users', 'Subscribers', 'Catagories'];
          $element_count = [$post_counts, $post_published_count, $post_draft_count, $comment_counts, $unnaproved_comments_count, $user_counts, $subscriber_count, $category_count];
